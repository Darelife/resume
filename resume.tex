...
\usepackage{amsmath}
\usepackage[
    pdftitle={Prakhar Bhandari's Resume},
    pdfauthor={Prakhar Bhandari},
    pdfcreator={Prakhar Bhandari},
    colorlinks=true,
...
\begin{document}
    ...
    \section{Projects}
        ...
        \vspace{0.3 cm} % Increased from 0.3 cm
